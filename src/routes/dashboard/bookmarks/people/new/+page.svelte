...
<div class="isolate -space-y-px rounded-md shadow-sm bg-white">
    ...
    <div class="relative rounded-md rounded-t-none px-3 pb-1.5 pt-2.5 ring-1 ring-inset ring-gray-300 focus-within:z-10 focus-within:ring-2 focus-within:ring-orange-500">
      ...
      <input type="text" name="job-title" bind:value={listDescription} id="job-title" class="block w-full border-0 p-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="List description">
    </div>
  </div>
                ...
                <div class="flex flex-col items-center gap-4">
                    <UserCard pubkey={user.hexpubkey()}>
                        <button type="submit" class="
                            text-white bg-orange-600 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-orange-600 dark:hover:bg-orange-600 dark:focus:ring-orange-800
